...
def estimate_potential(gas_phase_mass_SOA, total_particulate_mass_species_time_SOA, folder_name):
    ...
    pd.DataFrame(potential).to_csv('SOA_potential'+folder_name+'.csv', index=False, header=False)
