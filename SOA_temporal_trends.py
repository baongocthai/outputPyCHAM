...
def SOA_insolation(time_interval, file_name, sheet, time_column, start_time, end_time, insolation_column, particulate_phase_mass_SOA, folder_name):
    ...
    pd.DataFrame(SOA_temporal_trends).to_csv("SOA_temporal_trends"+folder_name+".csv", index=False, header=False)
